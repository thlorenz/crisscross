    ...
    fn grid_4x4_30deg() {
        ...
        assert_eq!(
            ...
            [
                ...
                ((3, 0.000), (1, 1.366)).into(),
                // TODO: outside grid and not properly converted
                ((3, 1.098), (3, 0.000)).into()
            ]
        );
        ...
        assert_eq!(
            ...
            [
                ...
                ((2, 0.000), (0, 1.154)).into(),
                ((3, 0.000), (0, 1.731)).into(),
                // TODO: not properly converted
                ((2, 1.464), (2, 0.000)).into(),
                ((3, 2.196), (3, 0.000)).into()
            ]
        );
    }
